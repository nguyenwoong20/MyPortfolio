(() => {
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\gallery.ts
  ...
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\menu.ts
  ...
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\createElement.ts
  ...
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\colorScheme.ts
  ...
  // ns-hugo-imp:D:\MyPortfolio\assets\ts\languageSwitcher.ts
  var StackLanguageSwitcher = class {
    localStorageKey = "StackLanguage";
    currentLanguage;
    constructor(toggleEl) {
    ...
    updatePageLanguage() {
      ...
      if (this.currentLanguage === "en") {
        if (currentUrl.indexOf("/en/") !== -1) {
          ...
          const pathWithoutBase = window.location.pathname;
          targetUrl = window.location.origin + "/en" + pathWithoutBase;
        }
      } else {
        if (currentUrl.indexOf("/en/") !== -1) {
          const pathWithoutEn = window.location.pathname.replace("/en", "");
          targetUrl = window.location.origin + pathWithoutEn;
        } else {
          return;
        }
      }
  ...
  var languageSwitcher_default = StackLanguageSwitcher;

  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\scrollspy.ts
  ...
  // ns-hugo-imp:D:\MyPortfolio\themes\hugo-theme-stack\assets\ts\smoothAnchors.ts
  ...
  var Stack = {
    init: () => {
      ...
      new languageSwitcher_default(document.getElementById("language-toggle"));
    }
  };
